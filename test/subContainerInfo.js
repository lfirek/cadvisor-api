...
describe('#getSubContainerInfo', () => {
    ...
    it('request with default hostname and port', () => {
        ...
        requestPort = 8080;
        requestVersion = 'v1.3';
        requestUri = `/api/${requestVersion}/subcontainers/`;
        ...
        cadvisorApi.getSubContainerInfo();
    ...
    it('request with custom container data', () => {
        ...
        requestPort = 8787;
        requestVersion = 'v1.3';
        requestUri = `/api/${requestVersion}/subcontainers/${containerName}`;
        ...
        cadvisorApi.getSubContainerInfo(containerName);
